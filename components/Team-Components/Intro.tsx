                ...
                <Grid container>
                    <Grid sx={{marginLeft: '3%'}} xs={12} md={7}>
                        ...
                        <Typography
                            ...
                            latest and advanced technologies such as Cloud
                            Computing, Artificial Intelligence, Machine
                            Learning, Big Data, Web, and App development, etc.
                            through their interactive and free workshops. The
                            students get an exceptional experience through the
                            seminars conducted involving the industry
                            professionals. With the cooperation of various
                            domains such as Technical, Business, Creatives and
                            Public Relations and Documentation these events are
